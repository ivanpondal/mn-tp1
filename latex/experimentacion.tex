...
\begin{itemize}
    \item Generamos casos tests a partir de los valores del Alto Horno de Hierro, véase Sección \ref{instancias}, variando la cantidad de puntos de la discretización y seteando el $ninst$ en 1.
...
En esta sección nos interesa comparar los métodos implementados con respecto al tiempo computacional que insumen en instancias del problema con variación del $b$.
La hipótesis que se busca corroborar es que el método LU es mas rápido en este tipo de instancias que la Eliminación Gaussiana, debido a sus características.
\newline
\newline
...
A partir de estas afirmaciones, podemos concluir que, efectivamente, LU es más
rápido que Gauss en este tipo de instancias dinámicas.
