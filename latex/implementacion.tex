...
Luego, el algoritmo de regresion lineal basicamente utiliza la minimización de la suma de las distancias al cuadradado desde los puntos a la función linea. Esto se logra calculando la derivada con respecto a $a$ y $b$ y fijando estos en cero.
